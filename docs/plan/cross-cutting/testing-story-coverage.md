...
- `workspace members` has current page-flow coverage for invite/disable/restore/remove but still misses direct E2E and invite-status/joined-page closure; owner: [Membership, Access, and Catalog](/Users/opentoggl-ci/Code/opentoggl/docs/plan/product/membership-access-and-catalog.md).
