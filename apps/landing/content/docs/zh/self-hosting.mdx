---
title: 自托管
description: 在自己的机器上部署 OpenTickly — Docker Compose 一条命令拉起 Web + API + Postgres + Redis，5 分钟上线。100% Toggl API 兼容，官方客户端直连即可。
---
...
OpenTickly 没有 30 次/小时的 API 限流，这意味着 Claude、Cursor 这类 Agent 可以大胆用。配合 [`toggl-cli`](/zh/docs/ai-integration) 把技能包装进 Agent 环境，几分钟就能让 AI 帮你启停计时器、整理项目。
...
3. 粘贴 [`docker-compose.yml`](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml) 的内容
...
2. 项目名例如 `opentickly`
3. 选 **使用 docker-compose.yml**，粘贴 [compose 文件](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
4. 一路下一步完成向导
...
4. **Compose 内容**粘贴 [compose 文件](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
5. 点 **部署**，等三个容器变绿
...
- [GitHub 仓库](https://github.com/CorrectRoadH/OpenTickly) — 源码、Issues、Discussions
- 部署中遇到问题？欢迎在 [Issues](https://github.com/CorrectRoadH/OpenTickly/issues) 反馈
