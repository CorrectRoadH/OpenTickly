...
OpenTickly is developed in the open on GitHub. Every release is a tagged commit on `main`, published automatically to Docker Hub and to the hosted demo at [track.opentickly.com](https://track.opentickly.com). Self-hosted users pull the new image and rerun `docker compose up -d` to upgrade.
