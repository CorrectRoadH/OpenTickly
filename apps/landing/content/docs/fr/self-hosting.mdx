...
description: Déployez OpenTickly sur votre propre machine — un seul fichier Docker Compose démarre Web + API + Postgres + Redis, en ligne en 5 minutes. 100 % compatible avec l'API Toggl, les clients officiels s'y connectent directement.
---
...
3. Collez le contenu de [`docker-compose.yml`](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
3. Choisissez **Utiliser docker-compose.yml** et collez le [fichier compose](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
4. Dans **Contenu Compose**, collez le [fichier compose](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
- [Dépôt GitHub](https://github.com/CorrectRoadH/OpenTickly) — code source, Issues, Discussions
- Un souci au déploiement ? N'hésitez pas à le signaler sur les [Issues](https://github.com/CorrectRoadH/OpenTickly/issues)
