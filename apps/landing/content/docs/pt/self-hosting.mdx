...
description: Implante o OpenTickly na sua própria máquina — um único comando do Docker Compose sobe Web + API + Postgres + Redis e você está no ar em 5 minutos. 100% compatível com a API do Toggl; os clientes oficiais se conectam diretamente.
---
...
3. Cole o conteúdo do [`docker-compose.yml`](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
3. Escolha **Usar docker-compose.yml** e cole o [arquivo compose](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
4. Em **Conteúdo Compose**, cole o [arquivo compose](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
- [Repositório no GitHub](https://github.com/CorrectRoadH/OpenTickly) — código-fonte, Issues, Discussions
- Teve problemas na implantação? Relate em [Issues](https://github.com/CorrectRoadH/OpenTickly/issues)
