...
description: Despliega OpenTickly en tu propia máquina — Docker Compose levanta Web + API + Postgres + Redis con un solo comando y en 5 minutos lo tienes en línea. 100% compatible con la API de Toggl, los clientes oficiales se conectan directo.
---
...
- **OpenTickly** — Web UI + API REST (expone `8080` al exterior)
...
3. Pega el contenido de [`docker-compose.yml`](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
2. Nombre del proyecto, por ejemplo `opentickly`
3. Elige **Usar docker-compose.yml** y pega el [archivo compose](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
3. Nombre del proyecto `opentickly`, deja la ruta de almacenamiento por defecto
4. En **Contenido Compose** pega el [archivo compose](https://raw.githubusercontent.com/CorrectRoadH/OpenTickly/main/docker-compose.yml)
...
- [Repositorio en GitHub](https://github.com/CorrectRoadH/OpenTickly) — código fuente, Issues, Discussions
- ¿Problemas durante el despliegue? Cuéntalos en [Issues](https://github.com/CorrectRoadH/OpenTickly/issues)
